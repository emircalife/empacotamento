...
@Tag(name = "Produtos", description = "Tudo de Produtos desta API")
public interface ProdutoDocumentation {
    ...
    ResponseEntity<Produto> create(@RequestBody @Valid Produto obj);
    ...
    ResponseEntity<Produto> update(@RequestBody @Valid Produto obj);
}
